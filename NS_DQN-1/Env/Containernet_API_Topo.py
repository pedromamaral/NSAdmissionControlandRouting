...
from Env.Parameters_API import DOCKER_VOLUME,LOG_TIMEOUT
...
class ContainernetAPI:
    ...
    #Creates containers, switches and links between nodes according to the topology
            ...
            for line in topology.readlines():
                ...
                for node in cols[:2]:
                    if node[0] == 'S':
                        ...
                        self.dos(node, container_params)
    ...
    #Updates used bw values and the available bw from the links btween the switches
